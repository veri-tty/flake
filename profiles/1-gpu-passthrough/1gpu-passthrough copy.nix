{
    ...
    wm = {
      windows = {
        enable = lib.mkEnableOption {
          description = "Enable Windows with Single-GPU Passthrough.";
          default = false;
        };
      };
    };
  ...
  config = lib.mkIf config.wm.windows.enable {
    specialisation."VFIO".configuration = {
      system.nixos.tags = ["with-vfio"];
      vfio.enable = true;
    };
    # Boot configuration
    boot.kernelParams = ["iommu=pt" "video=efifb:off"];
    ...
    #       # Logout
    #       #source "/home/${config.user}/Desktop/Sync/Files/Tools/logout.sh"
    ...
    #       # Debugging
    #       # exec 19>/home/${config.user}/Desktop/stoplogfile
    #       # BASH_XTRACEFD=19
    #       # set -x
    ...
    #   "libvirt/vgabios/patched.rom".source = ./patched.rom;
    # };
  };
}
